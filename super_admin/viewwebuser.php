                ...
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <ul class="nav nav-pills ml-auto">
                      <li class="nav-item">
                        <a class="nav-link active" href="addwebuser.php"><i class="fas fa-user mr-2"></i>+ अधिक
                          वापरकर्ते जोडा</a>
                      </li>
                    </ul>
                  </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="p-2">
                          ...
                          <a href="viewwebuser.php?action=delete&&id=<?php echo $row['id'] ?>" title="Delete"
                            alt="Delete" class="btn btn-danger btn-xs delete_sale ml-4 mr-3">
                            <i class="fas fa-trash"></i> </a>
                          <a href="editwebuser.php?eid=<?php echo $row['id'] ?>" title="Edit" alt="Edit"
