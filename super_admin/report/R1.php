...
<body class="hold-transition sidebar-mini ">
  <div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
      <img src="../dist/img/lo.png" alt="Atrocity Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    </div>
    <!-- Navbar -->
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/government-master/index.php" style="text-decoration:none">Home</a>
                </li>
                      ...
                      <div class="col-md-12">
                        <div class="card card-primary">
                          <div class="card-header">
                            <h3 class="card-title" style="font-size:20px;vertical-align:middle">January ,2020 मध्ये
                              घडलेल्या गुन्हयांची माहिती</h3>
                          </div>
                          <div>
                            <form method="post">
                              <div class="card-body">
...
$year=$_POST['year'];
   ...
   // }
              ...
              <?php 
if(isset($_POST["filter"])){
$query1=mysqli_query($conn,"select type_of_offence from complaint_form where monthname(date)='$dat' and year(date)='$year' and district='navi mumbai' and type_of_offence='खून,'");
...
if(isset($_POST["filter"])){
  $query2=mysqli_query($conn,"select type_of_offence from complaint_form where monthname(date) ='$dat' and year(date)='$year' and district='navi mumbai' and type_of_offence='बलात्कार,'");
  ...
  echo "<td class=text-center>". $count2."</td>";}
    ...
    if(isset($_POST["filter"])){
      $query3=mysqli_query($conn,"select type_of_offence from complaint_form where monthname(date) ='$dat' and year(date)='$year' and district='navi mumbai' and type_of_offence='विनयभंग,'");
      ...
      if(isset($_POST["filter"])){
        $query4=mysqli_query($conn,"select type_of_offence from complaint_form where month(date) ='$dat'  and year(date)='$year' and district='navi mumbai' and type_of_offence='मारहाण,'");
        ...
        if(isset($_POST["filter"])){
          $query5=mysqli_query($conn,"select type_of_offence from complaint_form where monthname(date) ='$dat' and year(date)='$year' and district='navi mumbai' and type_of_offence='शिवीगाळ,'");
          ...
          echo "<td class=text-center>". $count5."</td>";}
            ...
            if(isset($_POST["filter"])){
              $query7=mysqli_query($conn,"select type_of_offence from complaint_form where monthname(date) ='$dat' and year(date)='$year' and district='navi mumbai' and type_of_offence='जाळपोळ,'");
              ...
              if(isset($_POST["filter"])){
                $query8=mysqli_query($conn,"select type_of_offence from complaint_form where monthname(date) ='$dat' and year(date)='$year' and district='navi mumbai' and type_of_offence='इतर,'");
...
?>
              ...
              <?php 
if(isset($_POST["filter"])){
  echo"<tr><td class='text-center'>2</td>
  <td class='text-center'>Raigarh</td>";
$query1=mysqli_query($conn,"select type_of_offence from complaint_form where  monthname(date) ='$dat' and year(date)='$year' and district='raigarh' and type_of_offence='खून,'");
$count1=mysqli_num_rows($query1);
if($dat=='select month'){
  echo "<div style='display:none></div>";
}else{
...
if(isset($_POST["filter"])){
  $query2=mysqli_query($conn,"select type_of_offence from complaint_form where monthname(date) ='$dat' and year(date)='$year' and district='raigarh' and type_of_offence='बलात्कार,'");
  $count2=mysqli_num_rows($query2);
  if($dat=='select month'){
    echo "<div style='display:none> </div>";
  }else{
  echo "<td class=text-center>". $count2."</td>";}
    ...
    if(isset($_POST["filter"])){
      $query3=mysqli_query($conn,"select type_of_offence from complaint_form where monthname(date) ='$dat' and year(date)='$year' and district='raigarh' and type_of_offence='विनयभंग,'");
      $count3=mysqli_num_rows($query3);
      if($dat=='select month'){
        echo "<div style='display:none></div>";
      }else{
      ...
      if(isset($_POST["filter"])){
        $query4=mysqli_query($conn,"select type_of_offence from complaint_form where monthname(date) ='$dat' and year(date)='$year' and district='raigarh' and type_of_offence='मारहाण,'");
        $count4=mysqli_num_rows($query4);
        if($dat=='select month'){
          echo "<div style='display:none></div>";
        }else{
        ...
        if(isset($_POST["filter"])){
          $query5=mysqli_query($conn,"select type_of_offence from complaint_form where monthname(date) ='$dat' and year(date)='$year' and district='raigarh' and type_of_offence='शिवीगाळ,'");
          $count5=mysqli_num_rows($query5);
          if($dat=='select month'){
            echo "<div style='display:none></div>";
          }else{
          echo "<td class=text-center>". $count5."</td>";}
            ...
            if(isset($_POST["filter"])){
              $query7=mysqli_query($conn,"select type_of_offence from complaint_form where monthname(date) ='$dat' and year(date)='$year' and district='raigarh' and type_of_offence='जाळपोळ,'");
              $count7=mysqli_num_rows($query7);   
              if($dat=='select month'){
                echo "<div style='display:none></div>";
              }else{             
              ...
              if(isset($_POST["filter"])){
                $query8=mysqli_query($conn,"select type_of_offence from complaint_form where monthname(date) ='$dat' and year(date)='$year' and district='raigarh' and type_of_offence='इतर,'");
                $count8=mysqli_num_rows($query8); 
                if($dat=='select month'){
                  echo "<div style='display:none></div>";
                }else{    
