             ...
             <div  id='DivIdToPrint'>
              ...
              <table id="tbl" class="table  table-hover table-bordered">
                ...
                <tr ><th class="text-center mb-4" colspan="26">Navi Mumbai</th></tr>
                   ...
                   $dat=$_POST['month'];
                   $year=$_POST['year'];
                   $sql=mysqli_query($conn,"select * from complaint_form where monthname(date) ='$dat' and year(date)='$year' and district='navi mumbai';");
                    $count=1;
                   ...
                   <?php 
                   $dat=$_POST['month'];
                   $query=mysqli_query($conn,"select * from complaint_form where monthname(date) ='$dat' and year(date)='$year' and district='raigarh';");
                    $count1=1;
