    ...
    <!-- <span class="right badge badge-danger">New</span> -->
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="R2.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>अहवाल २</p>
                  </a>
                </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/government-master/index.php" style="text-decoration:none">Home</a></li>
              <li class="breadcrumb-item active">R2</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="row mb-4">
                    ...
                    <label>From:</label>
                      ...
                      <div class="input-group ">
                        ...
                        <input type="date" class="form-control float-right" placeholder="2022-02-12" name="from_date" id="">
                      </div>
                    </div>
                    ...
                    <label>To:</label>
                      <div class="input-group ">
                        ...
                        <input type="date" class="form-control float-right" name="to_date" id="">
                      </div>
                    </div>
                  </div>
                  <!-- /.input group -->
   ...
   <div class=' card' id=''>
    ...
    color: white;'>
              ...
              <div class='card-header' style='margin-top:12px'>
                ...
                <h5 class=' text-center fw-bolder'> माहे $dat to $to, २०२१ मध्ये घडलेल्या गुन्हयांची माहिती</h5>
...
<?php 
if(isset($_POST["filter"])){
$query1=mysqli_query($conn,"select type_of_offence from complaint_form where  date between '$dat' and '$to' and district='navi mumbai' and type_of_offence='खून,'");
...
if(isset($_POST["filter"])){
  $query2=mysqli_query($conn,"select type_of_offence from complaint_form where date between '$dat' and '$to' and district='navi mumbai' and type_of_offence='बलात्कार,'");
  ...
  echo "<td class=text-center>". $count2."</td>";}
    ...
    if(isset($_POST["filter"])){
      $query3=mysqli_query($conn,"select type_of_offence from complaint_form where date between '$dat' and '$to' and district='navi mumbai' and type_of_offence='विनयभंग,'");
      ...
      if(isset($_POST["filter"])){
        $query4=mysqli_query($conn,"select type_of_offence from complaint_form where date between '$dat' and '$to' and district='navi mumbai' and type_of_offence='मारहाण,'");
        ...
        if(isset($_POST["filter"])){
          $query5=mysqli_query($conn,"select type_of_offence from complaint_form where date between '$dat' and '$to' and district='navi mumbai' and type_of_offence='शिवीगाळ,'");
          ...
          echo "<td class=text-center>". $count5."</td>";}
            ...
            if(isset($_POST["filter"])){
              $query7=mysqli_query($conn,"select type_of_offence from complaint_form where date between '$dat' and '$to' and district='navi mumbai' and type_of_offence='जाळपोळ,'");
              ...
              if(isset($_POST["filter"])){
                $query8=mysqli_query($conn,"select type_of_offence from complaint_form where date between '$dat' and '$to' and district='navi mumbai' and type_of_offence='इतर,'");
...
<td>Raigarh</td>
";
$query1=mysqli_query($conn,"select type_of_offence from complaint_form where  date between '$dat' and '$to' and district='raigarh' and type_of_offence='खून,'");
$count1=mysqli_num_rows($query1);
if($dat=='' && $to==''){
  echo "<div style='display:none></div>";
}else{
...
if(isset($_POST["filter"])){
  $query2=mysqli_query($conn,"select type_of_offence from complaint_form where date between '$dat' and '$to' and district='raigarh' and type_of_offence='बलात्कार,'");
  $count2=mysqli_num_rows($query2);
  if($dat=='' && $to==''){
    echo "<div style='display:none></div>";
  }else{
  echo "<td class=text-center>". $count2."</td>";}
    ...
    if(isset($_POST["filter"])){
      $query3=mysqli_query($conn,"select type_of_offence from complaint_form where date between '$dat' and '$to' and district='raigarh' and type_of_offence='विनयभंग,'");
      $count3=mysqli_num_rows($query3);
      if($dat=='' && $to==''){
        echo "<div style='display:none></div>";
      }else{
      ...
      if(isset($_POST["filter"])){
        $query4=mysqli_query($conn,"select type_of_offence from complaint_form where date between '$dat' and '$to' and district='raigarh' and type_of_offence='मारहाण,'");
        $count4=mysqli_num_rows($query4);
        if($dat=='' && $to==''){
          echo "<div style='display:none></div>";
        }else{
        ...
        if(isset($_POST["filter"])){
          $query5=mysqli_query($conn,"select type_of_offence from complaint_form where date between '$dat' and '$to' and district='raigarh' and type_of_offence='शिवीगाळ,'");
          $count5=mysqli_num_rows($query5);
          if($dat=='' && $to==''){
            echo "<div style='display:none></div>";
          }else{
          echo "<td class=text-center>". $count5."</td>";}
            ...
            if(isset($_POST["filter"])){
              $query7=mysqli_query($conn,"select type_of_offence from complaint_form where date between '$dat' and '$to' and district='raigarh' and type_of_offence='जाळपोळ,'");
              $count7=mysqli_num_rows($query7);  
              if($dat=='' && $to==''){
                echo "<div style='display:none></div>";
              }else{              
              ...
              if(isset($_POST["filter"])){
                $query8=mysqli_query($conn,"select type_of_offence from complaint_form where date between '$dat' and '$to' and district='raigarh' and type_of_offence='इतर,'");
                $count8=mysqli_num_rows($query8); 
                if($dat=='' && $to==''){
                  echo "<div style='display:none></div>";
                }else{    
...
<script>
    ...
    function export_data(){
     ...
     let table=document.getElementById("tbl");
      ...
      XLSX.writeFile(fb, 'report2.xlsx');
