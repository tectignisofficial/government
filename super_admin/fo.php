...
if(isset($_POST['sub_mit']))  
  ...
  {   
    ...
    $in_ch=mysqli_query($conn,"insert into victim(caseid,charge_sheet,aadhar_card,caste,caste_certificate,name,address)
    values ('$id','$charge_sheet','$aadhaar_card','$category_and_caste','$caste_certificate','$victim_name','$victim_address')");  
   }
	if($in_ch==1) 
  {   
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex form-group " style="margin-left: -12px;">
                      <div class="form-group col-6">
                        ...
                        <input type="hidden" required class="" name="id" value="<?php echo $id;?>" id="exampleदिनांक"
                          placeholder="">
                      </div>
                    </div>
                    <div class="d-flex form-group " style="margin-left: -12px;">
                      <div class="form-group col-6">
                        ...
                        <input type="text" required class="form-control" value="<?php echo $victim_name;?>"
                          name="victim_name" id="fff" placeholder="">
                      </div>
                      <div class="form-group col-6">
                        <label for="">पिडीत व्यक्तीचा पत्ता</label>
                        <input type="text" required class="form-control" value="<?php echo $victim_address;?>"
                          name="victim_address" id="fff2" placeholder="">
                      </div>
