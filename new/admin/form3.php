                                ...
                                <div class="card-body">
                                    <form class="form">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 modal-footer justify-content-between">                                            
                                                <a href="form2.html" class="btn btn-outline-secondary btn-prev waves-effect">
                                            ...
                                            <!-- <div class="col-md-12 modal-footer">
                                                <a href="form4.html"><button type="button" id="formsub" name="submit" class="btn btn-primary modal1 waves-effect waves-float waves-light" data-bs-toggle="modal">नमूद
                                                    करा</button></a>
                                            </div> -->
                                        </div>
                                    </form>
