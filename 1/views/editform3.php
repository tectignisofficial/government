        ...
        $category_and_caste=$arr['category_and_caste'];-->
                                        ...
                                        <div class="d-flex form-group " style="margin-left: -12px;">
                                            <div class="form-group col-6">
                                               ...
                                               <input type="hidden" required class="" name="caseid" value="<?php echo $caseid;?>"  id="exampleदिनांक" placeholder="">
                                            </div>
                                        </div>
                                        <div class="d-flex form-group " style="margin-left: -12px;">
                                            <div class="form-group col-6">
                                            ...
                                            <div class="form-group col-2">
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input class="custom-control-input" type="radio" id="customRadio4"
                                                        value="नाही" <?php if($aadhaar_card=='नाही') {?> <?php echo "checked";?> <?php }?> name="aadhaar_card">
