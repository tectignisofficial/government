                      ...
                      <div class="col-md-12">
                        <div class="card card-primary">
                          <div class="card-header">
                            <h3 class="card-title" style="font-size:20px;vertical-align:middle">2020-01-01 to 2022-04-23
                              मध्ये घडलेल्या गुन्हयांची माहिती</h3>
                          </div>
                          <div>
                            <form method="post">
                              <div class="card-body">
                                    ...
                                    <div class="row">
                                      <div class="col-md-6">
                                        ...
                                        <div class="input-group ">
                                          ...
                                          <input type="date" class="form-control float-right" placeholder="2022-02-12"
                                            name="from_date" id="">
                                        </div>
                                      </div>
                        ...
                        while($res=mysqli_fetch_array($sql)){
                          ?>
                                      <input class="form-control " name="district"
                                        value="<?php echo $res['district']; ?>" readonly>
                                      <?php
                        }
                        ?>
...
if(isset($_POST["filter"]) && ($_POST['district'])){
   ...
   <div class=' card' id=''>
    ...
    $i++;
                ...
                <?php 
if(isset($_POST["filter"]) && ($_POST['district'])){
$query1=mysqli_query($conn,"select type_of_offence from complaint_form where  date between '$dat' and '$to' and district='$district' and type_of_offence='खून,'");
...
if(isset($_POST["filter"]) && ($_POST['district'])){
  $query2=mysqli_query($conn,"select type_of_offence from complaint_form where date between '$dat' and '$to' and district='$district' and type_of_offence='बलात्कार,'");
  ...
  echo "<td class=text-center>". $count2."</td>";}
    ...
    if(isset($_POST["filter"]) && ($_POST['district'])){
      $query3=mysqli_query($conn,"select type_of_offence from complaint_form where date between '$dat' and '$to' and district='$district' and type_of_offence='विनयभंग,'");
      ...
      if(isset($_POST["filter"]) && ($_POST['district'])){
        $query4=mysqli_query($conn,"select type_of_offence from complaint_form where date between '$dat' and '$to' and district='$district' and type_of_offence='मारहाण,'");
        ...
        if(isset($_POST["filter"]) && ($_POST['district'])){
          $query5=mysqli_query($conn,"select type_of_offence from complaint_form where date between '$dat' and '$to' and district='$district' and type_of_offence='शिवीगाळ,'");
          ...
          echo "<td class=text-center>". $count5."</td>";}
            ...
            if(isset($_POST["filter"]) && ($_POST['district'])){
              $query7=mysqli_query($conn,"select type_of_offence from complaint_form where date between '$dat' and '$to' and district='$district' and type_of_offence='जाळपोळ,'");
              ...
              if(isset($_POST["filter"]) && ($_POST['district'])){
                $query8=mysqli_query($conn,"select type_of_offence from complaint_form where date between '$dat' and '$to' and district='$district' and type_of_offence='इतर,'");
