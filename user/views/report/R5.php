...
<!--                    <th class="text-center" colspan="2">&nbsp;</th>-->
                ...
                complaint_form.discription as discription from criminal inner join complaint_form on complaint_form.id=criminal.caseid inner join victim on victim.caseid=complaint_form.id  inner join image on image.caseid=complaint_form.id  ");
                  $count=1;
