                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex form-group " style="margin-left: -12px;">
                      <div class="form-group col-6">
                        ...
                        <input type="hidden" required class="" name="id" id="exampleदिनांक" placeholder="">
                      </div>
                    </div>
                    <div class="d-flex form-group " style="margin-left: -12px;">
                      <div class="form-group col-6">
                    ...
                    <div class="d-flex form-group " style="margin-left: -12px;">
                      ...
                      <div class="form-group col-6">
                        ...
                        <input type="number" required class="form-control" name="victim_age" id="exampleदिनांक fff4"
                          placeholder="">
                      </div>
