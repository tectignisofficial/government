                    ...
                    <div>
                      <div class="d-flex form-group " style="margin-left: -12px;">
                        <div class="form-group col-6">
                          ...
                          <input type="text" required class="form-control" name="criminal_name" id="exampleदिनांक"
                            placeholder="">
                        </div>
                        <div class="form-group col-6">
                      ...
                      <div class="d-flex form-group " style="margin-left: -12px;">
                        <div class="form-group col-6">
                          ...
                          <input type="Textbox" required class="form-control" name="category_and_caste"
                            id="Exampleप्रवर्ग आणि जात fff3" placeholder="">
                        </div>
                        <div class="form-group col-6">
                          <label for="exampleदिनांक">आरोपीचा वय</label>
                          <input type="number" required class="form-control" name="criminal_age" id="exampleदिनांक fff4"
                            placeholder="">
                        </div>
                      ...
                      <div class="form-group d-flex " style="margin-left: -12px;">
                        <div class="form-group col-2">
                          ...
                          <div class="custom-control custom-radio">
                            <input class="custom-control-input" required type="radio" id="customRadio1" value="होय"
