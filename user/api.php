...
$formz = mysqli_query($conn,$selectquery);
  ...
  {  
   ...
   $sql=mysqli_query($conn,"update complaint_form set book_no='$book_no',date='$date',complaint_no='$complaint_no',district='$district',police_station='$police_station',section='$section',complaint_filer_name='$complaint_filer_name',year='$year',complaint_filer_address='$complaint_filer_address',type_of_offence='$chk' where id='$id'");
        ...
        $in_ch=mysqli_query($conn,"insert into complaint_form(complaint_filer_address,complaint_filer_name,section,police_station,district,book_no,date,year,complaint_no,type_of_offence)
  ...
  // $sql= mysqli_query($conn,"UPDATE complaint_form SET criminal_name = '$criminal_name', criminal_address = '$criminal_address',year = '$year',category_and_caste = '$category_and_caste', caste_certificate = '$caste_certificate', aadhaar_card = '$aadhaar_card', bank_info = '$bank_info', charge_sheet = '$charge_sheet', medical_report = '$medical_report' where id = $id");
  // if($sql==1)
  // {
